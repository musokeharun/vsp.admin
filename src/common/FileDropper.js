...
const FileDropper = ({onDropEvent}) => {
    ...
    return (
        <div className={classNames("card card-body p-0 my-md-2 my-1", {"bg-transparent": isDragActive})}>
            <div {...getRootProps({className: "dropzone"})}
                ...
                <div className="dz-message" data-dz-message="data-dz-message">
                    <div className="dz-message-text mx-auto text-center">
                        <img className="me-2" src={cloud} width="25" alt=""/>
                        <span className={"fw-bolder text-black h4"}>Drop the video here</span>
